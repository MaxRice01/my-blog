...
coffee %>%
  ...
  ggplot(aes(x = total_cup_points, y = processing_method, color = processing_method)) + geom_count(show.legend=F) + ggtitle("Score per Processing Method") + xlab("Total Cup Score") + ylab("Processing Method")
```
...
coffee %>%
  ...
  ggplot(aes(x = mean_score, y = processing_method, color = processing_method)) +geom_point(show.legend=F) + facet_wrap(~ species) + ggtitle("Average Score per Species") +xlab("Mean Score") + ylab("Processing Method")
